...
public class CoTermNSPairCombiner {
	...
	public static class NSPairCombiner extends Reducer<Text, IntWritable, Text, IntWritable>{
	...
	public static void main(String[] args) throws Exception{
		...
		job.setJarByClass(CoTermNSPairCombiner.class);
		job.setMapperClass(TokenizerMapper.class);
		job.setCombinerClass(NSPairCombiner.class);
